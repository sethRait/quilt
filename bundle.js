...
"use strict";function getImage(e){var t=new Image,r=q.defer();return t.addEventListener("load",function(){var e=document.createElement("canvas");e.width=this.width,e.height=this.height;var t=e.getContext("2d");t.drawImage(this,0,0);var a=t.getImageData(0,0,this.width,this.height);r.resolve(a)}),t.addEventListener("error",function(e){r.reject(e)}),t.src=e,r.promise}var q=require("q");module.exports.getImage=getImage;

},{"q":4}],2:[function(require,module,exports){
"use strict";function transfer(e,t,r,a,n){return q.all([image_utils.getImage(e),image_utils.getImage(t)]).then(function(e){var t=e[0],u=e[1],i=u.width,l=u.height,o=i*l*4,d=texture._malloc(o),g=new Uint8ClampedArray(texture.HEAPU8.buffer,d,o),h=t.width*t.height*4,m=texture._malloc(h),f=new Uint8Array(texture.HEAPU8.buffer,m,h),s=i*l*4,_=texture._malloc(s),c=new Uint8ClampedArray(texture.HEAPU8.buffer,_,s);return f.set(t.data),c.set(u.data),texture._doTransfer(t.width,t.height,i,l,m,d,_,r,a,n),new ImageData(g,i,l)})}function synth(){var e=256,t=256,r=e*t*4,a=texture._malloc(r),n=new Uint8ClampedArray(texture.HEAPU8.buffer,a,r);return image_utils.getImage("/images/Food.0010.png").then(function(r){var u=r.width*r.height*4,i=texture._malloc(u),l=new Uint8Array(texture.HEAPU8.buffer,i,u);return l.set(r.data),texture._doSynth(r.width,r.height,e,t,i,a),new ImageData(n,e,t)})}var image_utils=require("./image_utils"),q=require("q"),texture={_malloc:Module._malloc,_doSynth:Module._doSynth,_doTransfer:Module._doTransfer,HEAPU8:Module.HEAPU8};console.log(Object.keys(texture)),window.transfer=transfer;
