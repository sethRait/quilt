...
"use strict";function transfer(e,t,r,a,n){var u=e,i=t,o=i.width,l=i.height,m=o*l*4,s=texture._malloc(m),f=new Uint8ClampedArray(texture.HEAPU8.buffer,s,m),g=u.width*u.height*4,d=texture._malloc(g),h=new Uint8Array(texture.HEAPU8.buffer,d,g),_=o*l*4,c=texture._malloc(_),w=new Uint8ClampedArray(texture.HEAPU8.buffer,c,_);return h.set(u.data),w.set(i.data),texture._doTransfer(u.width,u.height,o,l,d,s,c,r,a,n),new ImageData(f,o,l)}function transferFromCanvas(e,t,r,a,n){return image_utils.getImage(e).then(function(e){var u=t.getContext("2d"),i=u.getImageData(0,0,t.width,t.height);return transfer(e,i,r,a,n)})}function transferFromURL(e,t,r,a,n){return q.all([image_utils.getImage(e),image_utils.getImage(t)]).then(function(e){return transfer(e[0],e[1],r,a,n)})}function synth(){var e=256,t=256,r=e*t*4,a=texture._malloc(r),n=new Uint8ClampedArray(texture.HEAPU8.buffer,a,r);return image_utils.getImage("/images/Food.0010.png").then(function(r){var u=r.width*r.height*4,i=texture._malloc(u),o=new Uint8Array(texture.HEAPU8.buffer,i,u);return o.set(r.data),texture._doSynth(r.width,r.height,e,t,i,a),new ImageData(n,e,t)})}var image_utils=require("./image_utils"),q=require("q"),texture={_malloc:Module._malloc,_doSynth:Module._doSynth,_doTransfer:Module._doTransfer,HEAPU8:Module.HEAPU8};console.log(Object.keys(texture)),window.transferFromURL=transferFromURL,window.transferFromCanvas=transferFromCanvas;
